...
vim.opt.formatoptions:append {'w'} -- trailing white space indicates paragraph
vim.opt.formatoptions:append {'a'} -- Automatic formatting of paragraphs
...
packages = {
  ...
  -- code formatting
  {'g2boojum/vim-mcnp'}, -- MCNP syntax coloring
  {'g2boojum/vim-pweave'}, -- pweave syntax coloring
  {'g2boojum/vim-sweave-rst'}, -- sweave syntax coloring
